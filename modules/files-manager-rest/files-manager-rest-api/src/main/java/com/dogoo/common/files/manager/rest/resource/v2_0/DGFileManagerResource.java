...
@Generated("")
@ProviderType
public interface DGFileManagerResource {

	public static Builder builder() {
		return FactoryHolder.factory.create();
	}

	public Page<DGFileManager> getAllDGFileManager(String parentCode)
		throws Exception;
	...
	public Response postDGFileManagerBatch(
			DGFileManager dgFileManager, String callbackURL, Object object)
		throws Exception;

	public Page<DGFileManager> getAllDGFileManagerByPkType(
			String parentCode, String pkType)
		throws Exception;
