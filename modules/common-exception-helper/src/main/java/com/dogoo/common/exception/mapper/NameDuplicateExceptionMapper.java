...
@Component (
        property = {
                ...
                "osgi.jaxrs.name=Dogoo.Common.Exception.DG_NameDuplicateException"
        },
        service = ExceptionMapper.class
)
public class NameDuplicateExceptionMapper
        extends BaseExceptionMapper<DG_NameDuplicateException> {

    private final String TITLE_MSG = "[DG] - Name Duplicate Exception";

    @Override
    protected Problem getProblem(DG_NameDuplicateException exception) {
