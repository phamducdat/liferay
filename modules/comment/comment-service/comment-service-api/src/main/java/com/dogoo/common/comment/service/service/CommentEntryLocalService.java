...
public interface CommentEntryLocalService
	...
	public CommentEntry addComment(
		long customerId, long creatorId, CommentMapperModel model,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CommentEntry> getCommentsByPkIdAndPkName(
		long customerId, long classPkId, String classPkName);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CommentEntry> getCommentsByPkIdAndPkNameOfTreeComment(
	...
	public CommentEntry updateComment(
			long commentId, CommentMapperModel model,
			ServiceContext serviceContext)
