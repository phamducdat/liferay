...
/**
 * Provides the local service interface for EmoticonEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmoticonEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmoticonEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.common.comment.service.service.impl.EmoticonEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the emoticon entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmoticonEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EmoticonEntry addEmoticon(
		long customerId, long creatorId, EmoticonMapperModel model,
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EmoticonEntry addEmoticonEntry(EmoticonEntry emoticonEntry);
	...
	public EmoticonEntry createEmoticonEntry(long emoticonId);
	...
	public EmoticonEntry deleteEmoticonEntry(EmoticonEntry emoticonEntry);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EmoticonEntry deleteEmoticonEntry(long emoticonId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmoticonEntry fetchEmoticonEntry(long emoticonId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmoticonEntry fetchEmoticonEntryByExternalReferenceCode(
	...
	@Deprecated
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmoticonEntry fetchEmoticonEntryByReferenceCode(
		long companyId, String externalReferenceCode);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmoticonEntry fetchEmoticonEntryByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmoticonEntry> getEmoticonEntries(int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmoticonEntry> getEmoticonEntriesByClassPkIdAndClassPkName(
		long customerId, long classPkId, String classPkName);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmoticonEntry getEmoticonEntriesByClassPkIdAndClassPkNameAndUser(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmoticonEntry> getEmoticonEntriesByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmoticonEntry getEmoticonEntry(long emoticonId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmoticonEntry getEmoticonEntryByExternalReferenceCode(
			long companyId, String externalReferenceCode)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmoticonEntry getEmoticonEntryByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	...
	public EmoticonEntry updateEmoticon(
			long emoticonId, EmoticonMapperModel model,
			ServiceContext serviceContext)
		throws NoSuchEmoticonEntryException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EmoticonEntry updateEmoticonEntry(EmoticonEntry emoticonEntry);
