...
public abstract class BaseCommentResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/dogoo/comment-rest/v2.0/comments' -d $'{"classPkId": ___, "classPkName": ___, "content": ___, "externalReferenceCode": ___, "mentions": ___, "parentId": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/dogoo/comment-rest/v2.0/comments/{commentId}'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/dogoo/comment-rest/v2.0/comments/{commentId}'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/dogoo/comment-rest/v2.0/comments/{commentId}' -d $'{"classPkId": ___, "classPkName": ___, "content": ___, "externalReferenceCode": ___, "mentions": ___, "parentId": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/dogoo/comment-rest/v2.0/comments/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/dogoo/comment-rest/v2.0/parents'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	public void update(
		...
		for (Comment comment : comments) {
			putComment(
				(comment.getCommentId() != null) ? comment.getCommentId() :
