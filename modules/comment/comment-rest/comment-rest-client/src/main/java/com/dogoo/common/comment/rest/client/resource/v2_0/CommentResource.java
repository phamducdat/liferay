...
public interface CommentResource {
	...
	public HttpInvoker.HttpResponse postComponentHttpResponse(Comment comment)
		throws Exception;

	public void deleteComments(Long commentId) throws Exception;

	public HttpInvoker.HttpResponse deleteCommentsHttpResponse(Long commentId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse deleteCommentsDeletesHttpResponse(
			String classPkName, Long[] classPkId)
		throws Exception;
	...
	public static class CommentResourceImpl implements CommentResource {
		...
		public Comment postComponent(Comment comment) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postComponentHttpResponse(
				comment);
		...
		public HttpInvoker.HttpResponse postComponentHttpResponse(
				Comment comment)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/dogoo/comment-rest/v2.0/comments");
		...
		public void deleteComments(Long commentId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteCommentsHttpResponse(
				commentId);
		...
		public HttpInvoker.HttpResponse deleteCommentsHttpResponse(
				Long commentId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/dogoo/comment-rest/v2.0/comments/{commentId}");
		...
		public HttpInvoker.HttpResponse putCommentBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/dogoo/comment-rest/v2.0/comments/batch");
		...
		public void deleteCommentsDeletes(String classPkName, Long[] classPkId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteCommentsDeletesHttpResponse(classPkName, classPkId);
		...
		public HttpInvoker.HttpResponse deleteCommentsDeletesHttpResponse(
			...
			if (classPkId != null) {
				for (int i = 0; i < classPkId.length; i++) {
					httpInvoker.parameter(
						"classPkId", String.valueOf(classPkId[i]));
				}
			}

			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/dogoo/comment-rest/v2.0/parents");
