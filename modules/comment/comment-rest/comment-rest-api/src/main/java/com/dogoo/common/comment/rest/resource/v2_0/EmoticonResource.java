package com.dogoo.common.comment.rest.resource.v2_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/dogoo/comment-rest/v2.0
 *
 * @author khoa
 * @generated
 */
...
public interface EmoticonResource {
	...
	public Response postEmoticonBatch(String callbackURL, Object object)
		throws Exception;

	public void deleteEmoticon(Long emoticonId) throws Exception;

	public Response deleteEmoticonBatch(String callbackURL, Object object)
		throws Exception;
	...
	public Response putEmoticonBatch(String callbackURL, Object object)
		throws Exception;
