...
public class Mention implements Serializable {
	...
	public static Mention toDTO(String json) {
		return ObjectMapperUtil.readValue(Mention.class, json);
	}

	public static Mention unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Mention.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.dogoo.common.comment.rest.dto.v2_0.Mention",
		name = "x-class-name"
	)
