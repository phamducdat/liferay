 ...
 */
@Generated("")
@GraphQLName(description = "Tree  Comment", value = "TreeComment")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "TreeComment")
public class TreeComment implements Serializable {

	public static TreeComment toDTO(String json) {
		return ObjectMapperUtil.readValue(TreeComment.class, json);
	}

	public static TreeComment unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(TreeComment.class, json);
	}
	...
	public String toString() {
		...
		if (treeComments != null) {
			...
			for (int i = 0; i < treeComments.length; i++) {
				sb.append(String.valueOf(treeComments[i]));

				if ((i + 1) < treeComments.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.dogoo.common.comment.rest.dto.v2_0.TreeComment",
		name = "x-class-name"
	)
