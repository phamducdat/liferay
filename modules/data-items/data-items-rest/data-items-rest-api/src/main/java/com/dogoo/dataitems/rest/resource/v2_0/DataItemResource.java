package com.dogoo.dataitems.rest.resource.v2_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/dogoo/data-items-rest/v2.0
 *
 * @author khoa
 * @generated
 */
...
public interface DataItemResource {
	...
	public Response postDataItemBatch(String callbackURL, Object object)
		throws Exception;

	public void deleteDataItem(Long dataItemId) throws Exception;

	public Response deleteDataItemBatch(String callbackURL, Object object)
		throws Exception;

	public DataItem getDataItem(Long dataItemId) throws Exception;

	public DataItem putDataItem(Long dataItemId, DataItem dataItem)
		throws Exception;

	public Response putDataItemBatch(String callbackURL, Object object)
		throws Exception;
	...
	public DataItem putDataItemByExternalReferenceCode(
			String externalReferenceCode, DataItem dataItem)
		throws Exception;

	public Page<DataItem> getDataItemByParentCode(
			String type, String parentCode, Integer sibling)
		throws Exception;
