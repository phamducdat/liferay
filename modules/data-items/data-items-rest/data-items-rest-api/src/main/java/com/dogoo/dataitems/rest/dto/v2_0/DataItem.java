 ...
 */
@Generated("")
@GraphQLName(description = "DataItem model", value = "DataItem")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DataItem")
public class DataItem implements Serializable {

	public static DataItem toDTO(String json) {
		return ObjectMapperUtil.readValue(DataItem.class, json);
	}

	public static DataItem unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(DataItem.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.dogoo.dataitems.rest.dto.v2_0.DataItem",
		name = "x-class-name"
	)
