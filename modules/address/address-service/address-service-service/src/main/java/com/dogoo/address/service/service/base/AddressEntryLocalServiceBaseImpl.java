...
/**
 * Provides the base implementation for the address entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dogoo.address.service.service.impl.AddressEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dogoo.address.service.service.impl.AddressEntryLocalServiceImpl
 * @generated
 */
public abstract class AddressEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddressEntryLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddressEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AddressEntryLocalServiceUtil</code>.
	 */
	...
	public AddressEntry addAddressEntry(AddressEntry addressEntry) {
		...
		return addressEntryPersistence.update(addressEntry);
	}
	...
	public AddressEntry createAddressEntry(long addressId) {
		return addressEntryPersistence.create(addressId);
	}
	...
	public AddressEntry deleteAddressEntry(long addressId)
		...
		return addressEntryPersistence.remove(addressId);
	}
	...
	public AddressEntry deleteAddressEntry(AddressEntry addressEntry) {
		return addressEntryPersistence.remove(addressEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addressEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddressEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addressEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return addressEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addressEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return addressEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AddressEntry fetchAddressEntry(long addressId) {
		return addressEntryPersistence.fetchByPrimaryKey(addressId);
	}
	...
	public AddressEntry fetchAddressEntryByUuidAndGroupId(
		...
		return addressEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public AddressEntry fetchAddressEntryByExternalReferenceCode(
		...
		return addressEntryPersistence.fetchByC_ERC(
	...
	public AddressEntry fetchAddressEntryByReferenceCode(
		...
		return fetchAddressEntryByExternalReferenceCode(
			companyId, externalReferenceCode);
	}
	...
	public AddressEntry getAddressEntryByExternalReferenceCode(
		...
		return addressEntryPersistence.findByC_ERC(
			companyId, externalReferenceCode);
	}
	...
	public AddressEntry getAddressEntry(long addressId) throws PortalException {
		return addressEntryPersistence.findByPrimaryKey(addressId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(addressEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddressEntry.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			addressEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AddressEntry.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<AddressEntry>() {

				@Override
				public void performAction(AddressEntry addressEntry)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, addressEntry);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addressEntryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return addressEntryLocalService.deleteAddressEntry(
			(AddressEntry)persistedModel);
	}

	@Override
	public BasePersistence<AddressEntry> getBasePersistence() {
		return addressEntryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addressEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddressEntry> getAddressEntriesByUuidAndCompanyId(
		...
		return addressEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AddressEntry> getAddressEntriesByUuidAndCompanyId(
		...
		return addressEntryPersistence.findByUuid_C(
	...
	public AddressEntry getAddressEntryByUuidAndGroupId(
		...
		return addressEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AddressEntry> getAddressEntries(int start, int end) {
		return addressEntryPersistence.findAll(start, end);
	}
	...
	public int getAddressEntriesCount() {
		return addressEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddressEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addressEntryLocalService = (AddressEntryLocalService)aopProxy;

		_setLocalServiceUtilService(addressEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddressEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = addressEntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = AddressEntryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, addressEntryLocalService);
		}
	...
	protected AddressEntryLocalService addressEntryLocalService;

	@Reference
	protected AddressEntryPersistence addressEntryPersistence;
