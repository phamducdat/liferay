package com.dogoo.address.rest.client.resource.v2_0;
...
import com.dogoo.address.rest.client.problem.Problem;
...
public interface AddressResource {
	...
	public HttpInvoker.HttpResponse getAddressesHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse addAddressHttpResponse(Address address)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			deleteAddressByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getAddressByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putAddressByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Address address)
		throws Exception;
	...
	public static class AddressResourceImpl implements AddressResource {
		...
		public HttpInvoker.HttpResponse deleteAddressHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/dogoo/address-rest/v2.0/addresses/{addressId}");
		...
		public HttpInvoker.HttpResponse deleteAddressBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/dogoo/address-rest/v2.0/addresses/batch");
		...
		public Page<Address> getAddresses(
			...
			HttpInvoker.HttpResponse httpResponse = getAddressesHttpResponse(
		...
		public HttpInvoker.HttpResponse getAddressesHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/dogoo/address-rest/v2.0/addresses");
		...
		public Address addAddress(Address address) throws Exception {
			HttpInvoker.HttpResponse httpResponse = addAddressHttpResponse(
				address);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/dogoo/address-rest/v2.0/addresses/by-external-reference-code/{externalReferenceCode}");
