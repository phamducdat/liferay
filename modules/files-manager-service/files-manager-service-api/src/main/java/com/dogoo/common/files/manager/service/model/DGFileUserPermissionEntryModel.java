...
/**
 * The base model interface for the DGFileUserPermissionEntry service. Represents a row in the &quot;DG_FileUserPermission&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.dogoo.common.files.manager.service.model.impl.DGFileUserPermissionEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.dogoo.common.files.manager.service.model.impl.DGFileUserPermissionEntryImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface DGFileUserPermissionEntryModel
	extends BaseModel<DGFileUserPermissionEntry>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a dg file user permission entry model instance should use the {@link DGFileUserPermissionEntry} interface instead.
	 */
