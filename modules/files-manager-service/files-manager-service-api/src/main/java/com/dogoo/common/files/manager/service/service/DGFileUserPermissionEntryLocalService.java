...
/**
 * Provides the local service interface for DGFileUserPermissionEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DGFileUserPermissionEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DGFileUserPermissionEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.common.files.manager.service.service.impl.DGFileUserPermissionEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dg file user permission entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DGFileUserPermissionEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DGFileUserPermissionEntry createFileUserPermission(
		long customerId, long userId, long documentManagerFileId,
		FileUserPermissionMapperModel model, ServiceContext serviceContext);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileUserPermissionEntry> fetchByC_F(
		long customerId, long documentManagerFileId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileUserPermissionEntry> fetchByC_U(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileUserPermissionEntry> fetchByC_U_S(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileUserPermissionEntry> getAllByFileId(
		long customerId, long documentManagerFileId);
	...
	public DGFileUserPermissionEntry updateFileUserPermission(
		long customerId, long userId, long documentManagerFileId,
		FileUserPermissionMapperModel model, ServiceContext serviceContext);
