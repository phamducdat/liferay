...
/**
 * The base model interface for the DGFileSettingPermissionEntry service. Represents a row in the &quot;DG_FileSettingPermission&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.dogoo.common.files.manager.service.model.impl.DGFileSettingPermissionEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.dogoo.common.files.manager.service.model.impl.DGFileSettingPermissionEntryImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface DGFileSettingPermissionEntryModel
	extends BaseModel<DGFileSettingPermissionEntry>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a dg file setting permission entry model instance should use the {@link DGFileSettingPermissionEntry} interface instead.
	 */
