...
/**
 * Provides the local service interface for DGFileVersionEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DGFileVersionEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DGFileVersionEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.common.files.manager.service.service.impl.DGFileVersionEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dg file version entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DGFileVersionEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DGFileVersionEntry createDGFileVersionEntry(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileVersionEntry> getDGFileVersionEntries(int start, int end);
