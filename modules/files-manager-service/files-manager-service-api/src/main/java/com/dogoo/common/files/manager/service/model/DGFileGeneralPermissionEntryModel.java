...
/**
 * The base model interface for the DGFileGeneralPermissionEntry service. Represents a row in the &quot;DG_FileGeneralPermission&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.dogoo.common.files.manager.service.model.impl.DGFileGeneralPermissionEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.dogoo.common.files.manager.service.model.impl.DGFileGeneralPermissionEntryImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface DGFileGeneralPermissionEntryModel
	extends BaseModel<DGFileGeneralPermissionEntry>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a dg file general permission entry model instance should use the {@link DGFileGeneralPermissionEntry} interface instead.
	 */
