 ...
 */
@Deprecated
public class DGFilePermissionEntrySoap implements Serializable {

	public static DGFilePermissionEntrySoap toSoapModel(
		DGFilePermissionEntry model) {

		DGFilePermissionEntrySoap soapModel = new DGFilePermissionEntrySoap();
	...
	public static DGFilePermissionEntrySoap[] toSoapModels(
		DGFilePermissionEntry[] models) {

		DGFilePermissionEntrySoap[] soapModels =
			new DGFilePermissionEntrySoap[models.length];
	...
	public static DGFilePermissionEntrySoap[][] toSoapModels(
		...
		DGFilePermissionEntrySoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels =
				new DGFilePermissionEntrySoap[models.length][models[0].length];
		}
		else {
			soapModels = new DGFilePermissionEntrySoap[0][0];
		}
	...
	public static DGFilePermissionEntrySoap[] toSoapModels(
		List<DGFilePermissionEntry> models) {

		List<DGFilePermissionEntrySoap> soapModels =
			new ArrayList<DGFilePermissionEntrySoap>(models.size());

		for (DGFilePermissionEntry model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(
			new DGFilePermissionEntrySoap[soapModels.size()]);
	}

	public DGFilePermissionEntrySoap() {
	}
