...
/**
 * Provides the local service interface for DGFileDepartmentPermissionEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DGFileDepartmentPermissionEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DGFileDepartmentPermissionEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.common.files.manager.service.service.impl.DGFileDepartmentPermissionEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dg file department permission entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DGFileDepartmentPermissionEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DGFileDepartmentPermissionEntry addDGFileDepartmentPermissionEntry(
	...
	public DGFileDepartmentPermissionEntry
	...
	public DGFileDepartmentPermissionEntry createFileDepartmentPermission(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileDepartmentPermissionEntry> fetchByC_D(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileDepartmentPermissionEntry> fetchByC_F(
		long customerId, long documentManagerFileId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DGFileDepartmentPermissionEntry fetchDGFileDepartmentPermissionEntry(
		long fileDepartmentPermissionId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileDepartmentPermissionEntry> getAllByFileId(
		long customerId, long documentManagerFileId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFileDepartmentPermissionEntry>
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DGFileDepartmentPermissionEntry getDGFileDepartmentPermissionEntry(
			long fileDepartmentPermissionId)
		throws PortalException;
	...
	public DGFileDepartmentPermissionEntry updateRoleFileDepartmentPermission(
		long customerId, long userId, long departmentId,
		long documentManagerFileId, String role, ServiceContext serviceContext);
