...
/**
 * Provides the local service utility for DGFileGeneralPermissionEntry. This utility wraps
 * <code>com.dogoo.common.files.manager.service.service.impl.DGFileGeneralPermissionEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DGFileGeneralPermissionEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.dogoo.common.files.manager.service.service.impl.DGFileGeneralPermissionEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DGFileGeneralPermissionEntry addDGFileGeneralPermissionEntry(
		DGFileGeneralPermissionEntry dgFileGeneralPermissionEntry) {

		return getService().addDGFileGeneralPermissionEntry(
	 ...
	 */
	public static DGFileGeneralPermissionEntry
		createDGFileGeneralPermissionEntry(long fileGeneralPermissionId) {

		return getService().createDGFileGeneralPermissionEntry(
	...
	public static DGFileGeneralPermissionEntry
		...
		return getService().deleteDGFileGeneralPermissionEntry(
			dgFileGeneralPermissionEntry);
	}
	 ...
	 */
	public static DGFileGeneralPermissionEntry
			deleteDGFileGeneralPermissionEntry(long fileGeneralPermissionId)
		throws PortalException {
	...
	public static void deleteDGFileGeneralPermissionEntry(
		...
		getService().deleteDGFileGeneralPermissionEntry(
	...
	public static DGFileGeneralPermissionEntry
		fetchDGFileGeneralPermissionEntry(long fileGeneralPermissionId) {

		return getService().fetchDGFileGeneralPermissionEntry(
			fileGeneralPermissionId);
	}
	...
	public static DGFileGeneralPermissionEntry
		...
		return getService().fetchDGFileGeneralPermissionEntryByReferenceCode(
			companyId, externalReferenceCode);
	}
	...
	public static DGFileGeneralPermissionEntry
		...
		return getService().fetchDGFileGeneralPermissionEntryByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<DGFileGeneralPermissionEntry>
		getDGFileGeneralPermissionEntries(int start, int end) {

		return getService().getDGFileGeneralPermissionEntries(start, end);
	}
	...
	public static List<DGFileGeneralPermissionEntry>
		...
		return getService().getDGFileGeneralPermissionEntriesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getDGFileGeneralPermissionEntriesCount() {
		return getService().getDGFileGeneralPermissionEntriesCount();
	}
	 ...
	 * @throws PortalException if a dg file general permission entry with the primary key could not be found
	 */
	public static DGFileGeneralPermissionEntry getDGFileGeneralPermissionEntry(
			long fileGeneralPermissionId)
		throws PortalException {

		return getService().getDGFileGeneralPermissionEntry(
			fileGeneralPermissionId);
	}
	...
	public static DGFileGeneralPermissionEntry
		...
		return getService().getDGFileGeneralPermissionEntryByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static DGFileGeneralPermissionEntry
		...
		return getService().updateDGFileGeneralPermissionEntry(
			dgFileGeneralPermissionEntry);
	}
	...
	public static DGFileGeneralPermissionEntryLocalService getService() {
		return _service;
	}

	private static volatile DGFileGeneralPermissionEntryLocalService _service;
