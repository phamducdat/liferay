...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "CommonApiRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "CommonApiRest", version = "v2.0")
)
@Path("/v2.0")
public class OpenAPIResourceImpl {
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			add(EmployeeReferenceResourceImpl.class);
