...
/**
 * Provides the local service interface for AuditingEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AuditingEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AuditingEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.common.auditing.service.service.impl.AuditingEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the auditing entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuditingEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Indexable(type = IndexableType.REINDEX)
	public AuditingEntry addAuditingEntry(
		long customerId, long creatorId, long classPkId, String classPkName,
		AuditingMapperModel model, ServiceContext serviceContext);
	...
	public List<AuditingEntry> findByParentPKAndName(
		long parentPkId, String parentPkName);

	public List<AuditingEntry> findByPKAndName(
