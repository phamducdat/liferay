 ...
 * <code>com.dogoo.department.service.service.impl.DepartmentEntryLocalServiceImpl</code> and
...
public class DepartmentEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.dogoo.department.service.service.impl.DepartmentEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static DepartmentEntry addDepartmentEntry(
		...
		com.dogoo.department.service.mapper.model.DepartmentMapperModel model,
	...
	public static DepartmentEntry deleteDepartmentEntryById(long departmentId)
		throws PortalException {

		return getService().deleteDepartmentEntryById(departmentId);
	}
	...
	public static DepartmentEntry fetchDepartmentEntryByCode(
		long customerId, String code) {

		return getService().fetchDepartmentEntryByCode(customerId, code);
	}
	...
	public static DepartmentEntry fetchDepartmentEntryByName(
		long customerId, String name) {

		return getService().fetchDepartmentEntryByName(customerId, name);
	}
	...
	public static DepartmentEntry fetchDepartmentEntryByTax(
		long customerId, String tax) {

		return getService().fetchDepartmentEntryByTax(customerId, tax);
	}
	...
	public static List<DepartmentEntry> getDepartmentEntries(long customerId) {
		return getService().getDepartmentEntries(customerId);
	}

	public static List<DepartmentEntry> getDepartmentEntries(
		long customerId, long parentId) {

		return getService().getDepartmentEntries(customerId, parentId);
	}
	...
	public static String getDepartmentNameTree(long departmentId) {
		return getService().getDepartmentNameTree(departmentId);
	}
