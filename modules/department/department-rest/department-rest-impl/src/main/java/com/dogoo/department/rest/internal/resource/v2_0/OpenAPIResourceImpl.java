...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "DepartmentRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Dogoo DepartmentRest Sample", version = "v2.0")
)
@Path("/v2.0")
