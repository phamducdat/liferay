...
public interface ContactEntryLocalService
	...
	public ContactEntry addContactEntry(
		...
		String linkedin, ServiceContext context);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ContactEntry deleteContactEntry(long contactId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContactEntry fetchContactEntryByExternalReferenceCode(
	...
	@Deprecated
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContactEntry fetchContactEntryByReferenceCode(
		long companyId, String externalReferenceCode);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContactEntry fetchContactEntryByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ContactEntry> getContactEntriesByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContactEntry getContactEntry(long contactId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContactEntry getContactEntryByExternalReferenceCode(
			long companyId, String externalReferenceCode)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContactEntry getContactEntryByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
