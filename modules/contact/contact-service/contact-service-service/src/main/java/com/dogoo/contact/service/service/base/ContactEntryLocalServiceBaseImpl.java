 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dogoo.contact.service.service.impl.ContactEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dogoo.contact.service.service.impl.ContactEntryLocalServiceImpl
 * @generated
 */
public abstract class ContactEntryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ContactEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ContactEntryLocalServiceUtil</code>.
	 */
	...
	public ContactEntry deleteContactEntry(long contactId)
		...
		return contactEntryPersistence.remove(contactId);
	}
	...
	public ContactEntry fetchContactEntryByUuidAndGroupId(
		...
		return contactEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ContactEntry fetchContactEntryByExternalReferenceCode(
		...
		return contactEntryPersistence.fetchByC_ERC(
	...
	public ContactEntry fetchContactEntryByReferenceCode(
		...
		return fetchContactEntryByExternalReferenceCode(
			companyId, externalReferenceCode);
	}
	...
	public ContactEntry getContactEntryByExternalReferenceCode(
		...
		return contactEntryPersistence.findByC_ERC(
			companyId, externalReferenceCode);
	}
			...
			new ActionableDynamicQuery.PerformActionMethod<ContactEntry>() {
				...
				public void performAction(ContactEntry contactEntry)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, contactEntry);
				}
	...
	public List<ContactEntry> getContactEntriesByUuidAndCompanyId(
		...
		return contactEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ContactEntry> getContactEntriesByUuidAndCompanyId(
		...
		return contactEntryPersistence.findByUuid_C(
	...
	public ContactEntry getContactEntryByUuidAndGroupId(
		...
		return contactEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(contactEntryLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ContactEntryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, contactEntryLocalService);
		}
