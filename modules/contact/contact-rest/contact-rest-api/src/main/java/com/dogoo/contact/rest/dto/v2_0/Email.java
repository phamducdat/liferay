...
public class Email implements Serializable {
	...
	public static Email toDTO(String json) {
		return ObjectMapperUtil.readValue(Email.class, json);
	}

	public static Email unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Email.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.dogoo.contact.rest.dto.v2_0.Email",
		name = "x-class-name"
	)
