...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "ContactRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Dogoo ContactRest Sample", version = "v2.0")
)
@Path("/v2.0")
