package com.dogoo.common.auditing.rest.dto.v2_0;
 ...
 */
@Generated("")
@GraphQLName(description = "Auditing Model", value = "Auditing")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Auditing")
public class Auditing implements Serializable {

	public static Auditing toDTO(String json) {
		return ObjectMapperUtil.readValue(Auditing.class, json);
	}

	public static Auditing unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Auditing.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.dogoo.common.auditing.rest.dto.v2_0.Auditing",
		name = "x-class-name"
	)
